# Research v1 (FROZEN) — archive

Frozen research lane documentation, moved here when the resolver became the
only active production lane. Do not add strategies to this lane.

Original repo positioning: weather prediction-market alpha research engine
(Kalshi KXHIGHNY first) — an alpha falsification machine, not a bot.
